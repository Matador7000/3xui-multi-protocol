...
apt install git
git clone https://github.com/Matador7000/3xui-multi-protocol.git
...
git clone https://github.com/Matador7000/3xui-multi-protocol.git
  ...
  wget https://raw.githubusercontent.com/Matador7000/3xui-multi-protocol/master/3xui-multi-protocol.service
